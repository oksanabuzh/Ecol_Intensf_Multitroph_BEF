...
# EFs across aboveground vs belowground compartments and strata
...
#Services/Disservices (summarize)----
##Fig3e_1----
#  Services/disservices in total:
